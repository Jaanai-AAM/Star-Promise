...
public class ArmorRegistry {
    public static final Item SOLID_GOLD_CHESTPLATE = new ArmorItem(new SolidGoldArmorMaterial(), EquipmentSlot.CHEST,
            new Item.Settings().group(ItemGroupRegistry.STAR_PROMISE).rarity(Rarity.RARE));

    public static final Item CORNUCOPIA_HELMET = new ArmorItem(new CornucopiaArmorMaterial(), EquipmentSlot.HEAD,
            new Item.Settings().group(ItemGroupRegistry.STAR_PROMISE).rarity(Rarity.RARE).fireproof());
    ...
    public static void register() {
        Registry.register(Registry.ITEM, new Identifier(StarPromise.MOD_ID, "solid_gold_chestplate"),
                SOLID_GOLD_CHESTPLATE);
