...
import net.jaanai.content.item.tool.Hoes;
import net.jaanai.content.item.tool.Pickaxes;
...
public class ToolRegistry {
    public static final ToolItem AMETHYST_SWORD = new SwordItem(AmethystToolMaterial.INSTANCE,
    ...
    public static final ToolItem CRYSTAL_STALWART_SWORD = new SwordItem(CrystalToolMaterial.INSTANCE,
            12, -3.0F, new Item.Settings()
            .group(ItemGroupRegistry.STAR_PROMISE).rarity(Rarity.RARE).fireproof());
    public static final ToolItem CRYSTAL_SWORD = new SwordItem(CrystalToolMaterial.INSTANCE,
            3, -2.4F, new Item.Settings().group(ItemGroupRegistry.STAR_PROMISE));
    public static final ToolItem CRYSTAL_SHOVEL = new ShovelItem(CrystalToolMaterial.INSTANCE,
            1.5F, -3.0F, new Item.Settings().group(ItemGroupRegistry.STAR_PROMISE));
    public static final ToolItem CRYSTAL_PICKAXE = new Pickaxes(CrystalToolMaterial.INSTANCE,
            1, -2.8F, new Item.Settings().group(ItemGroupRegistry.STAR_PROMISE));
    public static final ToolItem CRYSTAL_AXE = new Axes(CrystalToolMaterial.INSTANCE,
            6.0F, -3.1F, new Item.Settings().group(ItemGroupRegistry.STAR_PROMISE));
    public static final ToolItem CRYSTAL_HOE = new Hoes(CrystalToolMaterial.INSTANCE,
            -2, -1.0F, new Item.Settings().group(ItemGroupRegistry.STAR_PROMISE));
